...
// Explanation 0
// Anna didn't eat item bill[1] = 10, but she shared the rest of the items with Brian. The total cost of the shared items is 3 + 2 + 9 = 14 and, split in half, the cost per person is b_actual = 7.
// Brian charged her b_charged = 12 for her portion of the bill.We print the amount Anna was overcharged, (b_charged - b_actual) = 12 - 7 = 5, on a new line.
...
function bonAppetit(bill, k, b) {
  ...
  let shareToBePaid = (sum - bill[k]) / 2;
  console.log(shareToBePaid === b ? "Bon Appetit" : b - shareToBePaid);
}
