...
function insertNodeAtPosition(llist, data, position) {
  ...
  // get previous node position i.e index - 1
...
console.log(JSON.stringify(insertNodeAtPosition(s.head, 1, 2))); // 16 13 1 7
...
s1.insertNode(10);
s1.insertNode(4);
console.log(JSON.stringify(insertNodeAtPosition(s1.head, 20, 3))); // 11 9 19 20 10 4

let s2 = new SinglyLinkedList();
s2.insertNode(1);
s2.insertNode(2);
s2.insertNode(3);
s2.insertNode(4);
s2.insertNode(5);
s2.insertNode(6);
console.log(JSON.stringify(insertNodeAtPosition(s2.head, 7, 5))); // 1 2 3 4 5 7 6
